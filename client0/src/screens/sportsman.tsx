		...
		<Container className='pt-5 container-fluid text-center d-flex flex-column'>
			...
			<Modal
				...
				<Modal.Body className='m-3'>
					<InputGroup>
						<FormControl placeholder="Введите ФИО" onChange={(e) => handleInputChange('name', e.target.value)} />
					</InputGroup>
					<InputGroup className="mt-4">
						<FormControl placeholder="Введите возраст" onChange={(e) => handleInputChange('age', e.target.value)} />
					</InputGroup>
					<InputGroup className="mt-4">
						<FormControl placeholder="Введите рост (см)" onChange={(e) => handleInputChange('size', e.target.value)} />
					</InputGroup>
					<InputGroup className="mt-4">
						<FormControl placeholder="Введите вес (кг)" onChange={(e) => handleInputChange('weight', e.target.value)} />
					</InputGroup>
				</Modal.Body>
				<Modal.Footer className='justify-content-between'>
